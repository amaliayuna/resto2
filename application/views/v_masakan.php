	...
	<div class="section__content section__content--p30">
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							...
							<strong class="card-title" v-if="headerText">Data Masakan</strong>
						</div>
						<div class="card-body">
			<a href="#tambah" class="btn tbn-info" data-toggle="modal"><span class="glyphicon glyphicon-plus">Tambah</span></a>
		...
		<tbody>
			...
			foreach ($arr as $dt_mas) {
				...
				<td><img src='.base_url("assets/gambar/$dt_mas->gambar").' width="125" height="100px"></img></td>
				<td>'.$dt_mas->harga.'</td>
...
<div class="modal fade" id="update_masakan" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
