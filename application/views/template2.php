                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="<?=base_url('index.php/Masakan/index')?>">Masakan</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('index.php/Pelanggan/index')?>">Pelanggan</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('index.php/User/index')?>">User</a>
                                </li>
                        ...
                        <li>
                            <a href="<?=base_url('index.php/Order/index')?>">
                                <i class="fas fa-chart-bar"></i>Verifikasi Order</a>
                        </li>
                        <li>
                            <a href="<?=base_url('index.php/Logout/index')?>">
